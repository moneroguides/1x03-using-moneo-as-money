...
With just the primary address, restore height and view key, it is possible to create something called a **View Only wallet**. This kind of wallet enables you and other parties the ability to view the incoming transactions attributed to your keys.
